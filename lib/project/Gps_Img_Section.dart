...
class Gps_Image_Section extends StatefulWidget {
  final void Function(AppType)? onOpen;
  final VoidCallback onClose;

  const Gps_Image_Section({
    super.key,
  ...
  @override
  State<Gps_Image_Section> createState() => _Gps_Image_SectionState();
}

class _Gps_Image_SectionState extends State<Gps_Image_Section> {
  int currentNumber = 1;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          customTopBar(onBack: () => widget.onOpen!(AppType.gps), scale: scale),
          ...
          Center(
            child: Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(12 * scale),
                child: Image.asset(
                  "assets/projects/Gps${currentNumber}.png",
                  fit: BoxFit.cover,
                ),
              ),
            ),
