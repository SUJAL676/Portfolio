          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                featureText(
                  scale,
                  "- This Portfolio Website is built using Flutter Web with a component-driven architecture to ensure scalability, responsiveness, and smooth animations.",
                ),
                featureText(
                  scale,
                  "- It showcases real-world projects, technical skills, and career milestones through interactive UI elements and app-like navigation.",
                ),
                featureText(
                  scale,
                  "- The portfolio supports modern UI effects, performance-optimized layouts, and a clean design system inspired by iOS.",
                ),
                ...
                //       builder: (context) {
                //         return AlertDialog(
                //           title: Text("You are viewing that only"),
                //         );
                //       },
                //     );
                //   },
