...
class Anekant_Img_Section extends StatefulWidget {
  final void Function(AppType)? onOpen;
  final VoidCallback onClose;
  const Anekant_Img_Section({
    super.key,
  ...
  @override
  State<Anekant_Img_Section> createState() => _Anekant_Img_SectionState();
}

class _Anekant_Img_SectionState extends State<Anekant_Img_Section> {
  int currentNumber = 1;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          customTopBar(
            onBack: () => widget.onOpen!(AppType.anekant),
            scale: scale,
          ),
          ...
          Center(
            child: Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(12 * scale),
                child: Image.asset(
                  "assets/projects/anekant${currentNumber}.png",
                  fit: BoxFit.cover,
                ),
              ),
            ),
